...
Route::get('/dados', 'DadosController@index')->name('dados');
...
Route::middleware('auth')->resource('produtos','ProdutosController');
Route::middleware('auth')->resource('categorias','CategoriasController');
Route::middleware('auth')->resource('bandas','BandasController');
